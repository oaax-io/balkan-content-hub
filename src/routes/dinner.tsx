...
export const Route = createFileRoute("/dinner")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Balkan Dinner mit Spezialitäten vom offenen Feuer im Balkaneros Rothenburg." },
      { property: "og:title", content: "Dinner — Balkaneros" },
      { property: "og:description", content: "Balkan Dinner mit Spezialitäten vom Grill." },
    ],
  }),
